...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { cliente_id: @proyecto.cliente_id, fecha_fin: @proyecto.fecha_fin, fecha_inicio: @proyecto.fecha_inicio, nombre: @proyecto.nombre }
    end
  ...
  test "should update proyecto" do
    patch :update, id: @proyecto, proyecto: { cliente_id: @proyecto.cliente_id, fecha_fin: @proyecto.fecha_fin, fecha_inicio: @proyecto.fecha_inicio, nombre: @proyecto.nombre }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
